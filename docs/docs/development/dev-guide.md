...
You first need to set up a BigBlueButton 2.5 server. See the instructions at [Install BigBlueButton 2.5](/administration/install).
...
Before you can start developing on BigBlueButton, you must install BigBlueButton 2.5 (see [installation steps](/administration/install)) and ensure it's working correctly. Make sure there were no errors during the installation and that you can join a session successfully.
