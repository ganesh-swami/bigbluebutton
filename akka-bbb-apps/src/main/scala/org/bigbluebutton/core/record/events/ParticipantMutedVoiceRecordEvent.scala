...
class ParticipantMutedVoiceRecordEvent extends AbstractVoiceRecordEvent {
  import ParticipantMutedVoiceRecordEvent._
...
object ParticipantMutedVoiceRecordEvent {
